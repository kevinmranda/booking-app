...
func main() {
	...
	for {
		...
		isValidName, isValidEmail, isValidTicketNumber := validateUserInput(userTickets, remainingTickets)
...
func validateUserInput(userTickets, remainingTickets uint) (bool, bool, bool) {
...
func bookTicket(remTickets, userTickets uint, bookings []string, firstName, lastName, email, conName string) []string {
