...
func main() {
	...
	for {
		...
		firstName, lastName, email, userT := getUserInputs()
		isValidName, isValidEmail, isValidTicketNumber := validateUserInput(firstName, lastName, email string, userTickets uint)
