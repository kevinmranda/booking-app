...
func sendTicket(userTickets uint, firstName, lastName, email string) {
	...
	auth := smtp.PlainAuth("", "kevinmranda042@gmail.com", "vpiz bihc qyyl ptah", "smtp.gmail.com")

	// Set up email details
	from := "kevinmranda042@gmail.com"
	to := []string{email}
	subject := "Conference Ticket"
	body := userTickets "tickets for "firstName lastName
